...
import { idlFactory } from './ue_template.did.js';
export { idlFactory } from './ue_template.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.UE_TEMPLATE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ue_template.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ue_template canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ue_template.did.js")._SERVICE>}
 */
export const ue_template = createActor(canisterId);
